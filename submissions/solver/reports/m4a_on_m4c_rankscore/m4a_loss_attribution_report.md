...
Rank column: `m4c_rank_score`

## Inputs

- `benchmark_summary`: `analysis\m4c\m4c_benchmark_summary.csv`
- `family_summary`: `analysis\m4c\m4c_family_summary.csv`
- `candidate_effectiveness`: `analysis\m4c\m4c_candidate_effectiveness.csv`
- `runner_json`: `submissions\solver\artifacts\run_m4c-default.json`
...
- m4c_rank_score vs evaluator usable_count: `20`
- m4c_rank_score vs evaluator approx_coverage: `0.263158`
- m4c_rank_score vs evaluator spearman_rs: `n/a`
- m4c_rank_score vs evaluator top5_inversions: `n/a`
...
Classification reasons:
- m4c_rank_score vs evaluator usable_count: `20`
- m4c_rank_score vs evaluator approx_coverage: `0.25`
- m4c_rank_score vs evaluator spearman_rs: `n/a`
- m4c_rank_score vs evaluator top5_inversions: `n/a`
- usable_count=69 >= 20
...
Classification reasons:
- m4c_rank_score vs evaluator usable_count: `20`
- m4c_rank_score vs evaluator approx_coverage: `0.273973`
- m4c_rank_score vs evaluator spearman_rs: `n/a`
- m4c_rank_score vs evaluator top5_inversions: `n/a`
- usable_count=67 >= 20

...
Rank column: `m4d_rank_score`

## Inputs

- `benchmark_summary`: `analysis\m4d\m4d_benchmark_summary.csv`
- `family_summary`: `analysis\m4d\m4d_family_summary.csv`
- `candidate_effectiveness`: `analysis\m4d\m4d_candidate_effectiveness.csv`
- `runner_json`: `submissions\solver\artifacts\run_m4d-default.json`
...
|---|---|---:|---|---|
| ibm01 | meaningful_win | 0.00053072 | inconclusive | persist_more_instrumentation_before_optimizer_changes |
| ibm02 | meaningful_win | 0.0133481 | prefilter_evaluator_disagreement | correlation_aware_ranking_or_prefilter_repair |
...
- selected_cost: `1.03797`
- delta: `0.00053072`
- relative_delta: `0.000511046`
...
- approx-prefilter vs evaluator spearman_rs: `-0.0202967`
- approx-prefilter vs evaluator top5_inversions: `1`
- unique_macros_in_scored: `35`
- unique_macro_ratio: `0.460526`
- placement_hash_collisions: `0`
- collision_ratio: `0`
- classification: `inconclusive`
- M4B recommendation: `persist_more_instrumentation_before_optimizer_changes`

Classification reasons:
- m4d_rank_score vs evaluator usable_count: `49`
- m4d_rank_score vs evaluator approx_coverage: `0.644737`
- m4d_rank_score vs evaluator spearman_rs: `-0.392775`
- m4d_rank_score vs evaluator top5_inversions: `4`
- No priority rule A-D matched.

### ibm02

- original_cost: `1.56585`
- selected_cost: `1.5525`
- delta: `0.0133481`
- relative_delta: `0.00852452`
- score_band: `meaningful_win`
...
- approx-prefilter vs evaluator spearman_rs: `-0.574169`
- approx-prefilter vs evaluator top5_inversions: `5`
- unique_macros_in_scored: `28`
- unique_macro_ratio: `0.35`
- placement_hash_collisions: `0`
- collision_ratio: `0`
...
Classification reasons:
- m4d_rank_score vs evaluator usable_count: `49`
- m4d_rank_score vs evaluator approx_coverage: `0.6125`
- m4d_rank_score vs evaluator spearman_rs: `-0.251531`
- m4d_rank_score vs evaluator top5_inversions: `5`
- usable_count=69 >= 20
- approx_coverage=0.8625 >= 0.50
- spearman_rs=-0.574169 < 0.30
- top5_inversions=5 >= 3
...
- approx-prefilter vs evaluator spearman_rs: `-0.857359`
- approx-prefilter vs evaluator top5_inversions: `5`
- unique_macros_in_scored: `28`
- unique_macro_ratio: `0.383562`
- placement_hash_collisions: `0`
- collision_ratio: `0`
- classification: `prefilter_evaluator_disagreement`
- M4B recommendation: `correlation_aware_ranking_or_prefilter_repair`
...
Classification reasons:
- m4d_rank_score vs evaluator usable_count: `47`
- m4d_rank_score vs evaluator approx_coverage: `0.643836`
- m4d_rank_score vs evaluator spearman_rs: `-0.751236`
- m4d_rank_score vs evaluator top5_inversions: `5`
- usable_count=67 >= 20
- approx_coverage=0.917808 >= 0.50
- spearman_rs=-0.857359 < 0.30
- top5_inversions=5 >= 3

## Aggregate Recommendation

- outcome: `majority_with_inconclusive`
